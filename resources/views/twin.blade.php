...
<section id="rooms">
    <div class="rooms-container">
            <div class="room">
                <div class="img">
                <img src="{{asset('Images/Standard4.jpg')}}" alt="">
                </div>
                <div class="content">
            ...
            <div class="room">
                <div class="img">
                <img src="{{asset('Images/Deluxe4.jpg')}}" alt="">
                </div>
                <div class="content">
            ...
            <div class="room">
                <div class="img">
                <img src="{{asset('Images/Economy4.jpg')}}" alt="">
                </div>
                <div class="content">
                <h2>Economy Room</h2>
                    <ul>
            ...
            <div class="room">
                <div class="img">
                <img src="{{asset('Images/Studio4.jpg')}}" alt="">
                </div>
                <div class="content">
                <h2>Studio Room</h2>
                    <ul>
